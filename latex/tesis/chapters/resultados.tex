...
\section{Cota superior del anti-thickness geométrico}\label{secc:descomposicion_thrackles_maximos}
  ...
  \subsection{Número de cruce de thrackles maximos }\label{secc:cnthracklemax}
...
\section{Anti-thickness de gráficas geométricas sin thrackles máximos}
  ...
  tipos de orden de $n$, con $n\in[8,10]$ para los cuáles no exsiten thrackles máximos, en la
  ...
  es recursivo y usa una técnica de backtracking. Discutimos con más detalle el algoritmo en la
  ...
  número coicide con el de la cota superior de la ecuación~\ref{eq_dn}, cuando $n=8$, decimos que $d(8)=6$.
  ...
  Tosos los números de tipo de orden de tamaño $n$, para $n \in [3,8]$, para los que se ejecutó el
  ...
  thrackles, no necesariamente máximos, de los d ibujos de $K_n$.
...
\section{Intersección de thrackles de $K_n$ con $3\leq n \leq 9$.}\label{secc:interseccion_thrackles}
    ...
    en la que el órden de los elementos importa es decir, dos composiciones
    ...
    Usando la definición~\ref{definicion_particion_guia} generamos las particiones gúia para todo entero
