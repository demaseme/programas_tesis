...
\subsection{Algoritmo para encontrar thrackles con $k$
  ...
  % \frac{1}{2}(n-1)n+\frac{1}{2}(n-1)n\left(\frac{1}{2}n(n-1))-1\right) +
  % \frac{1}{4}(n-1)n\left(\frac{1}{2}(n-1)n-2\right)\left(\frac{1}{2}(n-1)n-1\left) +  \] \]
 %  1/4 (-1 + n) n (-2 + 1/2 (-1 + n) n) (-1 + 1/2 (-1 + n) n) +
 % 1/12 (-1 + n) n (-3 + 1/2 (-1 + n) n) (-2 + 1/2 (-1 + n) n) (-1 +
 %    1/2 (-1 + n) n) +
 % 1/48 (-1 + n) n (-4 + 1/2 (-1 + n) n) (-3 + 1/2 (-1 + n) n) (-2 +
 %    1/2 (-1 + n) n) (-1 + 1/2 (-1 + n) n) +
 % 6 Binomial[1/2 (-1 + n) n, 6] + 7 Binomial[1/2 (-1 + n) n, 7] +
 % 8 Binomial[1/2 (-1 + n) n, 8] + 9 Binomial[1/2 (-1 + n) n, 9] +
 % 10 Binomial[1/2 (-1 + n) n, 10]
  ...
  %       \State \texttt{inters\_flag}=\texttt{inters\_flag} $\&\&$
