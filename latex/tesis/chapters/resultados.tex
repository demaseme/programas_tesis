...
\section{Cota inferior del anti-thickness geométrico de $K_n$}\label{sec:cota_inf}
  ...
  con un solo thrackle máximo puede ser descargada de la liga~\ref{link-withone} del apéndice~\ref{apendice_ligas}. La lista de tipos de orden para los cuales no existe un thrackle máximo
  está en la liga~\ref{link-thrWithoutMax} del apéndice~\ref{apendice_ligas}.
...
\section{Anti-thickness de gráficas geométricas sin thrackles máximos}
  ...
  liga~\ref{link-thrWithoutMax-at} del apéndice~\ref{apendice-ligas}. Para este mismo rango y los mismo tipos
  de orden obtuvimos las correspondientes descomposiciones, estas pueden ser descargadas en la
  liga~\ref{link-decomposiciones-nomax} del apéndice~\ref{apendice-ligas}. Con lo anterior demostramos el
  siguiente teorema.
  \begin{theorem}
...
\subsection{Algoritmo para encontrar thrackles con $k$
  ...
  pueden ser descargados de la liga~\ref{link-3to9} del apéndice~\ref{apendice_ligas}
...
usando particiones guía}\label{secc:descomposiciones_particiones}
  ...
  Estas funciones pueden encontrarse en la liga~\ref{link-github} del apéndice~\ref{apendice_ligas}.
