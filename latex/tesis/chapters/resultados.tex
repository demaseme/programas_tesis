...
\section{Cota superior del anti-thickness geométrico}\label{secc:descomposicion_thrackles_maximos}
  ...
  \subsection{Número de cruce de thrackles máximos }\label{secc:cnthracklemax}
    ...
    cumple para el tipo de orden en posición convexa. Encontramos también, que para $3 \leq n \leq
    8$ los conjuntos de puntos que son \emph{menos convexos}, esto es, que tienen $k$-convexidad
    alta, tienen anti-thickness mayor que el convexo por una unidad.
    ...
    Para cada $n$, con $n \in [3,10]$ listamos los tipos de orden, el número de thrackles máximos en cada tipo de orden y el número de cruce para cada tipo de orden. Estas listas están ordenados de acuerdo al número de thrackles en el tipo de orden de mayor a menor y pueden ser descargadas en la liga~\ref{link-thrMax_k} del apéndice~\ref{apendice-ligas}. Con este orden notamos que el número de thrackles máximos disminuye casi de la misma manera que el número de cruce.
...
\section{Anti-thickness de gráficas geométricas sin thrackles máximos}
  ...
  \begin{theorem}
    ...
    máximos es mayor que el anti-thickness geométrico de $K_n$, con $n \in [3,10]$.
  \end{theorem}
...
$K_n$}\label{secc:anti-thickness-dibujo}
  ...
  \begin{table}
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      $8$ & $1.20096\times10^7$ años  & 1943          & 9 días           \\ \hline
