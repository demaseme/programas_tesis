...
\frame{\frametitle{Algunas definiciones}
  \begin{block}{Descomposición de una gráfica.}
    ...
    \begin{figure}
      \centering
      \caption{Un dibujo de $K_5$ descompuesto en 10 y en 3 subgráficas.}
      \includegraphics[width=8cm]{imagenes/decomposition.png}
    \end{figure}
  \end{block}
...
\frame{\frametitle{Algunas definiciones}
  ...
  \begin{block}{Anti-thickness geométrico}
    El anti-thickness geométrico de una gráfica $G$, $\mathsf{at_g}(G)$ es la $k$ más pequeña tal que $G$ tiene una representación en el plano con anti-thickness $k$.
  \end{block}
}
\frame{\frametitle{Ejemplo de anti-thickness}
  \begin{figure}
    \centering
    \caption{Un dibujo de $K_5$ descompuesto en 10 y en 3 thrackles. El anti-thickness geométrico de $K_5$ es 3.}
    \includegraphics[width=10cm]{imagenes/decomposition.png}
  \end{figure}
}
...
\begin{figure}
  \centering
  \includegraphics[width=7cm]{imagenes/thmax.png}
  \caption{Dos thrackles máximos comparten una arista.}
\end{figure}
}
\frame{
\begin{figure}
  \centering
  \includegraphics[width=8cm]{imagenes/dec_explanation.png}
\end{figure}
}
...
\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec1.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec2.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec3.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec4.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec5.png}
}


\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec6.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec6_2.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec7.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec8.png}
}

\frame{\frametitle{Ejemplo de descomposición}
\includegraphics[width=8cm]{imagenes/k9_dec9.png}
}
...
\section{Extra}
\frame{
\begin{block}{Dibujo de una gráfica}
  ...
  \begin{figure}[h]
    \caption{$K_4$ y dos dibujos de $K_4$ distintos.}
    \centering
